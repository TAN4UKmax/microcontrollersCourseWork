...
public:
     ...
     */
    bool SetConfig(unsigned long baud = 9600,
        char parity = 'N',
        unsigned char dataBit = 8,
        unsigned char stopBit = 1);
     ...
     */
    bool SetReadTimeouts(unsigned long interval = 0,
     ...
     */
    long Write(char* buf, unsigned char length);
     ...
     */
    long Read(char* buf, unsigned char length);
};
